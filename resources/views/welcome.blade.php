...
<head>
    ...
    <title>Ateneo de Davao University Enlistment</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/img/logo/addu_2.png') }}">
    <!-- Google Fonts
		============================================ -->
	...
	<div class="error-pagewrap">
        ...
        <img src="{{ asset('assets/img/logo/addu_2.png')}}" alt="logo">
			...
			<div class="text-center login-footer">
				<p>Copyright © 2019. All rights reserved. Powered by Ateneo de Davao University</p>
			</div>
		</div>
    </div>
    <!-- jquery
